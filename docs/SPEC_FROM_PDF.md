...
| Log Note with file/Drive-link attachments + @mentions | ⚠ partial | Comments + @mentions + Drive-link auto-recognition already exist. Storage attachments require bucket configuration before full support. |

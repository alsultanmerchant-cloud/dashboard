-- 0128_list_tasks_bundle_pagination.sql
--
-- Adds offset-based pagination and an exact filtered total to the task bundle
-- RPC so /tasks can load incrementally without lying about counts.
...
grant execute on function public.list_tasks_bundle(
  uuid, int, int, text[], text[], text[], uuid, boolean, boolean, boolean, boolean,
  boolean, text[], boolean, uuid, uuid, text, jsonb, boolean, boolean, boolean,
  boolean, boolean, boolean, boolean, boolean, jsonb, uuid[]

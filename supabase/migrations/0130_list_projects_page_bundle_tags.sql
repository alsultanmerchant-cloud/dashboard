-- Inline project_tag_assignments (custom project tags like HOLD/Urgent) into
-- list_projects_page_bundle so the /projects page renders in one round-trip
-- instead of bundle-RPC + tags-followup.

...
قواعد صارمة:
- **ممنوع ذكر أي أرقام أو نسب أو مبالغ في نصّك نهائيًا** (لا أرقامًا لاتينية ولا عربية). الموجز توجيه نصّي خالص؛ الأرقام يراها المدير في صفحات التفاصيل. صف الحجم نوعيًا: «عدد كبير/محدود»، «تصاعد ملحوظ»، «مبلغ مؤثّر على السيولة».
- إن كان اسم مشروع/باقة يحوي رقمًا (مثل «نوفا 3 شهور») فاذكر الاسم بدون الرقم أو اسم العميل بدله.
- البيانات الرقمية أدناه هي لفهمك أنت فقط — كي تعرف أين يتركّز الخلل وما حجمه — لا لنقلها حرفيًا.
...
التعليمات:
- **headline**: جملة واحدة بأسلوب سكرتير يُطلع مديره صباحًا: تجيب هل نتحسّن أم نتراجع و**أين** يتركّز التغيّر (الخدمة/المرحلة/العميل)، مستندةً إلى verdictArabic و changes و today و context — **بلا أي أرقام**. مثال: "الوضع ${VERDICT_AR[s.verdict]} — أبرز ما يستحق انتباهك اليوم تراكم مهام متجاوزة لمهلها في خدمة كذا…".`,
      knowledge,
    );
  },
};
